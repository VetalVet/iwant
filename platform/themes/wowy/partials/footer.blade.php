    ...
    {{-- <script defer src="/themes/wowy/js/assets/swiper-bundle.min.js"></script> --}}
    <script defer src="/themes/wowy/js/dynamicAdapt.js"></script>
    <script defer src="/themes/wowy/js/popup.js"></script>
    <script defer src="/themes/wowy/js/common.js"></script>

    @if($_SERVER['REQUEST_URI'] == '/')
        <script defer src="/themes/wowy/js/index.js"></script>
    {{-- @elseif(str_contains($_SERVER['REQUEST_URI'], 'product-categories') || str_contains($_SERVER['REQUEST_URI'], 'products'))
        <script defer src="/themes/wowy/js/nouislider.js"></script>
        <script defer src="/themes/wowy/js/wNumb.min.js"></script>
        <script defer src="/themes/wowy/js/select.js"></script>

        <script defer src="/themes/wowy/js/main.js"></script>
        <script defer src="/themes/wowy/js/shop.js"></script> --}}
    @elseif(str_contains($_SERVER['REQUEST_URI'], 'products'))
        <script defer src="/themes/wowy/js/product.js"></script>
    @endif
    {!! Theme::place('footer') !!}
</body>
